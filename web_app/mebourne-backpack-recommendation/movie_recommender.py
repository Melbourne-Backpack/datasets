...
st.markdown('# HOUSING RECOMMENDER SYSTEM')
...
options = main_layout.multiselect('What type of housing options do you like?', movie["title"].unique())
show_recommended_movies_btn = search_layout.button("search")

# add widgets on sidebar
recommended_movie_num = st.sidebar.slider("Recommended housing number", min_value=5, max_value=10)
